...
namespace UnitTest
{
	...
	public class TestCase3
	{
		...
		public void main()
		{
			...
			string url				= apiHost + "api/v1.0/Gov/AA090UserJuminCheckResApp";
			...
			bodies.Add("CertPassword"			, aesEncrypt(aesKey, aesIv, File.ReadAllText("D:\\pwd.txt")));
			bodies.Add("PersonName"				, "홍길동");
			bodies.Add("IdentityNumber"			, aesEncrypt(aesKey, aesIv, "8801011234567"));
			bodies.Add("PublishDate"			, "20220101");
