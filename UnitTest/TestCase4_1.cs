...
namespace UnitTest
{
	...
	public class TestCase4_1
	{
		...
		public void main()
		{
			...
			bodies.Add("PrivateAuthType"		, "");
			bodies.Add("UserName"				, aesEncrypt(aesKey, aesIv, "홍길동"));
			bodies.Add("BirthDate"				, aesEncrypt(aesKey, aesIv, "19880101"));
			bodies.Add("UserCellphoneNumber"	, aesEncrypt(aesKey, aesIv, "01012341234"));
