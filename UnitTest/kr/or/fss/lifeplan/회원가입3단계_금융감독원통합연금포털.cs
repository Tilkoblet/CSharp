...
namespace UnitTest.kr.or.fss.lifeplan
{
    [TestClass]
    public class 회원가입3단계_금융감독원통합연금포털
    {
        ...
        public void main()
        {
            ...
            string url				= apiHost + "api/v1.0/FssLifeplan/RegisterStep3";
            

            // API 요청 파라미터 설정
            Dictionary<string, string> bodies	= new Dictionary<string, string>();
            bodies.Add("UserId", aesEncrypt(aesKey, aesIv, "__VALUE__"));
            bodies.Add("Password", aesEncrypt(aesKey, aesIv, "__VALUE__"));
            bodies.Add("PhoneNumber1", aesEncrypt(aesKey, aesIv, "__VALUE__"));
            bodies.Add("PhoneNumber2", aesEncrypt(aesKey, aesIv, "__VALUE__"));
            bodies.Add("PhoneNumber3", aesEncrypt(aesKey, aesIv, "__VALUE__"));
            bodies.Add("Email", aesEncrypt(aesKey, aesIv, "__VALUE__"));
            bodies.Add("SmsCode", "__VALUE__");
            bodies.Add("RegionCode1", "__VALUE__");
            bodies.Add("RegionCode2", "__VALUE__");
