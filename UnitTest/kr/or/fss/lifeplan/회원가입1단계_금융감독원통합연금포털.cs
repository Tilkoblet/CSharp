...
namespace UnitTest.kr.or.fss.lifeplan
{
    ...
    public class 회원가입1단계_금융감독원통합연금포털
    {
        ...
        public void main()
        {
            ...
            bodies.Add("UserName", aesEncrypt(aesKey, aesIv, "__VALUE__"));
            bodies.Add("BirthDate", aesEncrypt(aesKey, aesIv, "__VALUE__"));
            bodies.Add("IdentityNumber", aesEncrypt(aesKey, aesIv, "__VALUE__"));
            bodies.Add("MobileCorp", "__VALUE__");
            bodies.Add("PhoneNumber", aesEncrypt(aesKey, aesIv, "__VALUE__"));
