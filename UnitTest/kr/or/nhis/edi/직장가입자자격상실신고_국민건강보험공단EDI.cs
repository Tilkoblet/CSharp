...
namespace UnitTest.kr.or.nhis.edi
{
    ...
    public class 직장가입자자격상실신고_국민건강보험공단EDI
    {
        ...
        public void main()
        {
            ...
            string url				= apiHost + "api/v1.0/NhisEdi/JGBB_030";
            ...
            bodies.Add("IdentityNumber", aesEncrypt(aesKey, aesIv, "__VALUE__"));
            bodies.Add("FirmMgmtNo", "__VALUE__");
            bodies.Add("FirmSym", "__VALUE__");
            bodies.Add("UnitFirmSym", "__VALUE__");
            bodies.Add("GeunrojaName", "__VALUE__");
            bodies.Add("GeunrojaRgNo", aesEncrypt(aesKey, aesIv, "__VALUE__"));
            bodies.Add("SangsilDt", "__VALUE__");
            bodies.Add("DBosuChongak", "__VALUE__");
            bodies.Add("DSanjengMM", "__VALUE__");
            bodies.Add("JBosuChongak", "__VALUE__");
            bodies.Add("JSanjengMM", "__VALUE__");
            bodies.Add("LossRsnTypeCd", "__VALUE__");
            bodies.Add("SangsilSayuDetail", "__VALUE__");
            bodies.Add("NhicLossCd", "__VALUE__");
            bodies.Add("NpcLossCd", "__VALUE__");
