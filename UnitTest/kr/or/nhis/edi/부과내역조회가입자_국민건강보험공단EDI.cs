...
namespace UnitTest.kr.or.nhis.edi
{
    ...
    public class 부과내역조회가입자_국민건강보험공단EDI
    {
        ...
        public void main()
        {
            ...
            string url				= apiHost + "api/v1.0/NhisEdi/BMBB_020";
            ...
            bodies.Add("WrtChasu", "__VALUE__");
            bodies.Add("WrtDupSeq", "__VALUE__");
            bodies.Add("GojiYyyymm", "__VALUE__");
            bodies.Add("GojiChasu", "__VALUE__");
            bodies.Add("DocId", "__VALUE__");
            bodies.Add("NationFinanceCd", "__VALUE__");
