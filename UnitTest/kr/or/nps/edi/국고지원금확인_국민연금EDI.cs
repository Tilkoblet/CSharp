...
namespace UnitTest.kr.or.nps.edi
{
    ...
    public class 국고지원금확인_국민연금EDI
    {
        ...
        public void main()
        {
            ...
            string url				= apiHost + "api/v1.0/NpsEdi/U040209M01";
            ...
            bodies.Add("DocNo", "__VALUE__");
            bodies.Add("TrDt", "__VALUE__");
            bodies.Add("FmCd", "__VALUE__");
            bodies.Add("RgstChrgpId", "__VALUE__");
