...
namespace UnitTest.kr.or.longtermcare
{
    [TestClass]
    public class 심사지급통보서조회_장기요양보험공단
    {
        ...
        public void main()
        {
            ...
            string url				= apiHost + "api/v1.0/Longtermcare/NPCA702M01";
            ...
            bodies.Add("BusinessNumber", "__VALUE__");
            bodies.Add("DateType", "__VALUE__");
            bodies.Add("Start", "__VALUE__");
            bodies.Add("End", "__VALUE__");
