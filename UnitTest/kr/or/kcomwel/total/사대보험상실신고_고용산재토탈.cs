...
namespace UnitTest.kr.or.kcomwel.total
{
    ...
    public class 사대보험상실신고_고용산재토탈
    {
        ...
        public void main()
        {
            ...
            string url				= apiHost + "api/v1.0/Kcomwel/SamuSangsilSingo";
            ...
            bodies.Add("SangsilSayu", "__VALUE__");
            bodies.Add("SangsilSayuDetail", "__VALUE__");
            bodies.Add("NHICSangsilBuhoCd", "__VALUE__");
            bodies.Add("NPSSangsilBuhoCd", "__VALUE__");
