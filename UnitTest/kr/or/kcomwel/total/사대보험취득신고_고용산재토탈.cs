...
namespace UnitTest.kr.or.kcomwel.total
{
    [TestClass]
    public class 사대보험취득신고_고용산재토탈
    {
        ...
        public void main()
        {
            ...
            string url				= apiHost + "api/v1.0/Kcomwel/SamuChwideukSingo";
            ...
            bodies.Add("UserGroupFlag", "__VALUE__");
            bodies.Add("IndividualFlag", "__VALUE__");
            bodies.Add("GwanriNo", "__VALUE__");
            bodies.Add("GeunrojaRgNo", aesEncrypt(aesKey, aesIv, "__VALUE__"));
            bodies.Add("GeunrojaNm", "__VALUE__");
            bodies.Add("JikJongCd", "__VALUE__");
            bodies.Add("ChwideukMMNapbuYN", "__VALUE__");
            bodies.Add("GyeYakJikYN", "__VALUE__");
            bodies.Add("ChwideukDt", "__VALUE__");
            bodies.Add("JuSojeongGeunroTm", "__VALUE__");
            bodies.Add("MmAvgBosu", "__VALUE__");
            bodies.Add("NPSChwideukBuho", "__VALUE__");
            bodies.Add("NHICChwideukBuho", "__VALUE__");
            bodies.Add("GYBYN", "__VALUE__");
            bodies.Add("NHICYN", "__VALUE__");
            bodies.Add("NPSYN", "__VALUE__");
            bodies.Add("SJBYN", "__VALUE__");
            bodies.Add("ILJARIYN", "__VALUE__");
            bodies.Add("CheryuJakyeok", "__VALUE__");
            bodies.Add("GyeyakToDt", "__VALUE__");
            bodies.Add("GukJeok", "__VALUE__");
