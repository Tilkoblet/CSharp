...
namespace UnitTest.kr.or.kcomwel.total
{
    ...
    public class 개인별부과고지보험료조회_고용산재토탈
    {
        ...
        public void main()
        {
            ...
            string url				= apiHost + "api/v1.0/Kcomwel/SelectGaeinbyeolBhrNaeyeok";
            ...
            bodies.Add("BoheomYear", "__VALUE__");
            bodies.Add("Geunroja_RgNo", aesEncrypt(aesKey, aesIv, "__VALUE__"));
