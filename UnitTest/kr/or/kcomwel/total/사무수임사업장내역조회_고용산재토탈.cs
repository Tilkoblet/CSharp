...
namespace UnitTest.kr.or.kcomwel.total
{
    ...
    public class 사무수임사업장내역조회_고용산재토탈
    {
        ...
        public void main()
        {
            ...
            string url				= apiHost + "api/v1.0/Kcomwel/SelectSdgSaeopjangInfoNaeyeok";
            ...
            bodies.Add("BoheomFg", "__VALUE__");
            bodies.Add("BugwaGojiYn", "__VALUE__");
            bodies.Add("SjSaeopFg", "__VALUE__");
            bodies.Add("GySaeopFg", "__VALUE__");
            bodies.Add("GySaeopjangStatusCd", "__VALUE__");
            bodies.Add("SjSaeopjangStatusCd", "__VALUE__");
            bodies.Add("GwanriNo", "__VALUE__");
            bodies.Add("GwanriJisaCd", "__VALUE__");
            bodies.Add("JeopsuInfoJoheoYN", "__VALUE__");
            bodies.Add("JeopsuDtFrom", "__VALUE__");
            bodies.Add("JeopsuDtTo", "__VALUE__");
