...
namespace UnitTest.kr.or.kcomwel.total
{
    ...
    public class 일자리안정자금신청_고용산재토탈
    {
        ...
        public void main()
        {
            ...
            string url				= apiHost + "api/v1.0/Kcomwel/T100010191014";
            ...
            bodies.Add("GeupyeoPrc", "__VALUE__");
            bodies.Add("JuSojeongGeunroTm", "__VALUE__");
            bodies.Add("GamsidansokYn", "__VALUE__");
            bodies.Add("Mm3MimanSuseopYn", "__VALUE__");
            bodies.Add("JaGeupyeoFg", "__VALUE__");
