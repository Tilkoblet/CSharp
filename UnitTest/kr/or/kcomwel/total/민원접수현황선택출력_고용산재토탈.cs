...
namespace UnitTest.kr.or.kcomwel.total
{
    ...
    public class 민원접수현황선택출력_고용산재토탈
    {
        ...
        public void main()
        {
            ...
            string url				= apiHost + "api/v1.0/Kcomwel/PrintPdfJingsuMinwon";
            ...
            bodies.Add("MinwonDocCd", "__VALUE__");
            bodies.Add("ImsiJeopsuNo", "__VALUE__");
            bodies.Add("PubapAcptNo", "__VALUE__");
            bodies.Add("JeopsuNo", "__VALUE__");
