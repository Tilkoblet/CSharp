...
namespace UnitTest.kr.or.kcomwel.total
{
    ...
    public class 일용직신고_고용산재토탈
    {
        ...
        public void main()
        {
            ...
            string url				= apiHost + "api/v1.0/Kcomwel/T100010111005";
            ...
            bodies.Add("RgNo", aesEncrypt(aesKey, aesIv, "__VALUE__"));
            bodies.Add("Name", "__VALUE__");
            bodies.Add("Year", "__VALUE__");
            bodies.Add("Month", "__VALUE__");
            bodies.Add("BosuChongak", "__VALUE__");
            bodies.Add("GeunroDays", "__VALUE__");
            bodies.Add("IlAvgGeunroTm", "__VALUE__");
