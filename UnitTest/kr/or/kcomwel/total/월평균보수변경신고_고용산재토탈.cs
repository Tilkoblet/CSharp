...
namespace UnitTest.kr.or.kcomwel.total
{
    ...
    public class 월평균보수변경신고_고용산재토탈
    {
        ...
        public void main()
        {
            ...
            string url				= apiHost + "api/v1.0/Kcomwel/MMAvgChangeSingo";
            ...
            bodies.Add("BosuChangeMMAvg", "__VALUE__");
            bodies.Add("ChangeSayuCd", "__VALUE__");
            bodies.Add("BosuChangeDt", "__VALUE__");
            ...
            bodies.Add("NpsGeunrojaDonguiYn", "__VALUE__");
            bodies.Add("NpsGijunSodeukPrc", "__VALUE__");
