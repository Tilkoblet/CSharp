...
namespace UnitTest.kr.go.efine
{
    ...
    public class 운전면허진위여부_경찰청교통민원24
    {
        ...
        public void main()
        {
            ...
            string url				= apiHost + "api/v1.0/Efine/LicenTruth";
            

            // API 요청 파라미터 설정
            Dictionary<string, string> bodies	= new Dictionary<string, string>();
            bodies.Add("BirthDate", "__VALUE__");
            bodies.Add("Name", "__VALUE__");
            bodies.Add("LicNumber", aesEncrypt(aesKey, aesIv, "__VALUE__"));
            bodies.Add("SpecialNumber", aesEncrypt(aesKey, aesIv, "__VALUE__"));
