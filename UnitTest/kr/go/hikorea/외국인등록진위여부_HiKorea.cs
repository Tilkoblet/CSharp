...
namespace UnitTest.kr.go.hikorea
{
    ...
    public class 외국인등록진위여부_HiKorea
    {
        ...
        public void main()
        {
            ...
            string url				= apiHost + "api/v1.0/HiKorea/InfoFrnRegIdChkRsltR/kr";
            ...
            bodies.Add("TargetIdentityNumber", aesEncrypt(aesKey, aesIv, "__VALUE__"));
            bodies.Add("TargetPublishDate", "__VALUE__");
