...
namespace UnitTest.kr.go.hometax
{
    ...
    public class 신용카드매출자료조회_세무대리용
    {
        ...
        public void main()
        {
            ...
            string url				= apiHost + "api/v1.0/HometaxAgent/UTESFABG25/SuImNabSeJa/SinYongCard/MaeChulJaLyo";
            ...
            bodies.Add("StartQuarter", "__VALUE__");
            bodies.Add("EndQuarter", "__VALUE__");
