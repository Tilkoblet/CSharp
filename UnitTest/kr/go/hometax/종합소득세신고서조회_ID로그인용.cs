...
namespace UnitTest.kr.go.hometax
{
    ...
    public class 종합소득세신고서조회_ID로그인용
    {
        ...
        public void main()
        {
            ...
            string url				= apiHost + "api/v1.0/HometaxIdLogin/UTERNAAZ110/JongHabSoDeugSe/SinGo";
            

            // API 요청 파라미터 설정
            Dictionary<string, string> bodies	= new Dictionary<string, string>();
            bodies.Add("UserId", aesEncrypt(aesKey, aesIv, "__VALUE__"));
            bodies.Add("UserPassword", aesEncrypt(aesKey, aesIv, "__VALUE__"));
            bodies.Add("BusinessNumber", aesEncrypt(aesKey, aesIv, "__VALUE__"));
            bodies.Add("StartDate", "__VALUE__");
            bodies.Add("EndDate", "__VALUE__");
