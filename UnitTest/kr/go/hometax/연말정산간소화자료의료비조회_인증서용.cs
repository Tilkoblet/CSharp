...
namespace UnitTest.kr.go.hometax
{
    ...
    public class 연말정산간소화자료의료비조회_인증서용
    {
        ...
        public void main()
        {
            ...
            string url				= apiHost + "api/v1.0/HometaxGeneral/ATEYSCAA006R01";
            ...
            bodies.Add("DetailYN", "__VALUE__");
            bodies.Add("RptPdfMskOpCldrYn", "__VALUE__");
            bodies.Add("Months", "__VALUE__");
