...
namespace UnitTest.kr.go.hometax
{
    ...
    public class 지급명세서등제출내역PDF_인증서용
    {
        ...
        public void main()
        {
            ...
            string url				= apiHost + "api/v1.0/HometaxGeneral/ATESFZAA001R04/MyeongSeSeo/Pdf";
            ...
            bodies.Add("CvaId", "__VALUE__");
            bodies.Add("IeTin", "__VALUE__");
            bodies.Add("LvyRperTin", "__VALUE__");
            bodies.Add("MateKndNm", "__VALUE__");
