...
namespace UnitTest.kr.go.iros
{
    ...
    public class 등기부등본조회_인터넷등기소
    {
        ...
        public void main()
        {
            ...
            string url				= apiHost + "api/v1.0/Iros/RISURetrieve";
            

            // API 요청 파라미터 설정
            Dictionary<string, string> bodies	= new Dictionary<string, string>();
            bodies.Add("IrosID", aesEncrypt(aesKey, aesIv, "__VALUE__"));
            bodies.Add("IrosPwd", aesEncrypt(aesKey, aesIv, "__VALUE__"));
            bodies.Add("EmoneyNo1", aesEncrypt(aesKey, aesIv, "__VALUE__"));
            bodies.Add("EmoneyNo2", aesEncrypt(aesKey, aesIv, "__VALUE__"));
            bodies.Add("EmoneyPwd", aesEncrypt(aesKey, aesIv, "__VALUE__"));
            bodies.Add("UniqueNo", "__VALUE__");
            bodies.Add("JoinYn", "__VALUE__");
            bodies.Add("CostsYn", "__VALUE__");
            bodies.Add("DataYn", "__VALUE__");
            bodies.Add("ValidYn", "__VALUE__");
