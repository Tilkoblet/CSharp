...
namespace UnitTest.kr.gov
{
    ...
    public class 임야대장열람_정부24
    {
        ...
        public void main()
        {
            ...
            string url				= apiHost + "api/v1.0/Gov/AA040MinwonFormForestText";
            ...
            bodies.Add("SearchWord", "__VALUE__");
            bodies.Add("BonBunji", "__VALUE__");
            bodies.Add("PrintHistory", "__VALUE__");
            bodies.Add("IsClosed", "__VALUE__");
            bodies.Add("ShowOwnerIdentityNumber", "__VALUE__");
            bodies.Add("OfficialValueYear", "__VALUE__");
            bodies.Add("IdentityNumber", aesEncrypt(aesKey, aesIv, "__VALUE__"));
            bodies.Add("BuBunji", "__VALUE__");
