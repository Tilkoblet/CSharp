...
namespace UnitTest.kr.gov
{
    ...
    public class 건축물대장열람_정부24
    {
        ...
        public void main()
        {
            ...
            string url				= apiHost + "api/v1.0/Gov/AA040MinwonFormBuildingText";
            ...
            bodies.Add("BldgLedgerGubun", "__VALUE__");
            bodies.Add("BldgLedgerJongryu", "__VALUE__");
            bodies.Add("SearchWord", "__VALUE__");
            bodies.Add("SearchDong", "__VALUE__");
            bodies.Add("SearchHo", "__VALUE__");
