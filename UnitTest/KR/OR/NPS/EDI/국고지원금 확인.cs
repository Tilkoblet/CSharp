	...
	public class 국고지원금확인
	{
		...
		public void TILKO_API()
		{
			try
			{
				...
				_rest.AddBody("BusinessNumber", Constant.CertPassword, true); // [암호화] 검색 할 사업자등록번호 또는 주민등록번호(xxxxxxxxxx 또는 xxxxxxxxxxxxx / Base64 인코딩)
				_rest.AddBody("DOC_NO", "");
                _rest.AddBody("CONFIRM_DT", "");
				_rest.AddBody("FM_CD", "");
				_rest.AddBody("RGST_CHRGP_ID", "");
