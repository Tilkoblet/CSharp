	...
	public class 원천세신고서조회세무대리용
	{
		...
		public void TILKO_API()
		{
			try
			{
				...
				_rest.AddBody("AgentId", "");                     // [암호화] 세무대리인 ID(세무대리 관리번호가 있는 경우 / Base64 인코딩)
                _rest.AddBody("AgentPassword", "");               // [암호화] 세무대리인 암호(세무대리 관리번호가 있는 경우 / Base64 인코딩)
				_rest.AddBody("BusinessNumber", "");              // [암호화] 검색 할 사업자등록번호 또는 주민등록번호(xxxxxxxxxx 또는 xxxxxxxxxxxxx / Base64 인코딩) 공백일 검색기간은 30일, 아닐경우 검색기간은 365일
