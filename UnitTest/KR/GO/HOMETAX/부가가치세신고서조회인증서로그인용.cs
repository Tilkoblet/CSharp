...
{
	[TestClass]
	public class 부가가치세신고서조회인증서로그인용
	{
		[TestMethod]
		public void TILKO_API()
		{
			try
			{
				...
				// 홈택스의 부가가치세 신고서 조회인증서 로그인용 endPoint 설정
				...
				_rest.AddBody("BusinessNumber", "", true);            // 검색 할 사업자등록번호 또는 주민등록번호(xxxxxxxxxx 또는 xxxxxxxxxxxxx / Base64 인코딩) 공백일 검색기간은 30일, 아닐경우 검색기간은 365일
